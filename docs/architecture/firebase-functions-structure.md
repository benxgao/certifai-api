...
- [docs/architecture/overview.md](./overview.md) – Architecture hub for the backend and adjacent domains. Ref: `functions/src/index.ts`
- [docs/architecture/adaptive-exam-generation.md](./adaptive-exam-generation.md) – Exam planning and adaptive topic selection. Ref: `functions/src/services/genkit/examPlanner.ts`
- [docs/architecture/exam_active.md](./exam_active.md) – Exam status lifecycle and live status polling. Ref: `functions/src/endpoints/api/users/exams/getExamLiveStatus.ts`
- [docs/architecture/exam_data.md](./exam_data.md) – Persistence and transition data flow for exam generation. Ref: `functions/src/utils/examQuestionAssociation.ts`
- [docs/architecture/knowledge-pooling.md](./knowledge-pooling.md) – Async post-exam analysis and insight generation. Ref: `functions/src/delegators/tasks/knowledge-pooling/`
- [docs/architecture/redis-cache.md](./redis-cache.md) – Cache architecture and service-layer boundaries. Ref: `functions/src/services/cache/index.ts`
