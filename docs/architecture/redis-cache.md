...
- [docs/cache/redis-patterns.md](../cache/redis-patterns.md) — Canonical Redis keying, TTL, and invalidation patterns. Ref: `functions/src/services/redis/index.ts`
- [docs/services/service-catalog.md](../services/service-catalog.md) — Service boundaries for cache, Redis, and related infrastructure. Ref: `functions/src/services/cache/index.ts`
- [docs/architecture/overview.md](./overview.md) — Architecture hub that explains where caching fits in the system. Ref: `functions/src/services/cache/cacheHierarchy.ts`
- [docs/architecture/database-design.md](./database-design.md) — Storage model and cross-store linkage map that drive cache invalidation. Ref: `functions/src/services/cache/cacheHierarchy.ts`
- [docs/testing/strategy.md](../testing/strategy.md) — Testing guidance for cache behavior and invalidation flows. Ref: `functions/src/services/cache/memoryCache.ts`
