...
type GenerateKnowledgePoolingParams = {
  user_id: string;
  cert_id: string;
};

type GenerateKnowledgePoolingBody = {
  exam_id?: string;
 ...
 */
export const generateKnowledgePooling: AuthenticatedRequestHandler<
  GenerateKnowledgePoolingBody,
  Record<string, unknown>,
  GenerateKnowledgePoolingParams
